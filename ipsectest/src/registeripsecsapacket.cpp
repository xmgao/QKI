#include "registeripsecsapacket.hpp"
...
void RegisterIPSECSAPacket::ConstructRegisterIPSECSAPacket(uint32_t sourceip_, uint32_t desip_, uint32_t spi, bool is_inbound, bool is_otpalg)
{
...
void RegisterIPSECSAPacket::ConstructDestoryIPSECSAPacket(uint32_t sourceip_, uint32_t desip_, uint32_t spi, bool is_inbound, bool is_otpalg)
{
