 ...
 * @LastEditTime: 2024-07-17 20:42:01
 * @FilePath: \cc:\Users\Administrator\Desktop\quantumnet\IPSec\strongswan版本\project-20240717\project2\src\external_comm.c
 * @Description:
 *
...
#define DATA_SIZE 64
#define PACKET_SIZE (METHOD_SIZE + DATA_SIZE)
